...
const Header = () => {
    ...
    const menuItems = [
        ...
        { icon: "ri-login-circle-line", label: "Signup", link: "/signup" },
    ...
    return (
        <>
            ...
            {isMenuOpen && (
                <>
                    <div
                        className="absolute max-h-screen rounded-3xl overflow-hidden inset-0 bg-gray-500 backdrop-blur-xl bg-opacity-10 z-50"
                        onClick={() => setIsMenuOpen(false)}
                    />

                    <div className="absolute rounded-3xl max-h-screen overflow-hidden bg-[#EEFAFB] inset-y-0 left-0 w-[75%] shadow-2xl z-50 flex flex-col">
