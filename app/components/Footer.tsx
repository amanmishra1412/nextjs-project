...
const Footer = () => {
    ...
    const removeRoute = ["/premium", "/profile", "/search", "/about", "/signup", '/login'];
    if (removeRoute.includes(pathname)) return "";

    return (
        <footer className="absolute px-5 bottom-0 inset-x-0 mx-4 rounded-3xl bg-[#D4F2F6] border-[2px] border-white z-40">
